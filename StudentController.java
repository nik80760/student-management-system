 ...
 
 {
	  ...
	  public String uploadStudent(@PathVariable Long id,
	     ...
	     public String confirmDeleteAll() {
	         return "confirm_delete_all"; // A template or view to show the confirmation message
	     }

	     @PostMapping("/delete/all")
	     public String deleteAll() {
	         studentService.deleteAllStudents(); // Assuming you have a method in the service for this
	         return "redirect:/students"; // Redirect to the student list page or another appropriate page
	     }
...
//	             // Assuming you store authenticated student's ID in the session
//	             Long studentId = (Long) session.getAttribute("authenticatedStudentId");
//	             
//	             if (studentId != null) {
